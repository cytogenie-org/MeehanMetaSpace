...
public class TextAreaWithHint extends JTextArea{
	...
	public TextAreaWithHint(final int rows, final int cols){
		super(rows,cols);
		setMargin(new Insets(0,4,0,3));
        setLineWrap(true);
        ...
        setOpaque(true);
        GradientBasics.setTransparentChildrenWhenVisible(this);
	}
