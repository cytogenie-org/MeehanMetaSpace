...
public class ToolTipOnDemand
  ...
  private static boolean isPgSoft=!Basics.isMac();
...
public void showWhenAdded(final JComponent component){
...
public void hierarchyChanged(HierarchyEvent e){
  ...
  public void show(
      ...
      show(
        ...
        widthOffset,
        heightOffset,
        userMustClose ? SwingBasics.getButton("Close", 'c', new ActionListener() {
  ...
  public void show(
      ...
      if (enabled) {
          ...
          final Rectangle sBounds = SwingBasics.getScreen(insideComponent);
          boolean leftToRight
          ...
          tip = new MyToolTip();
          if (isPgSoft){
        	  tip.set(new javax.swing.plaf.basic.BasicToolTipUI());
          }
          ...
          final JPanel jp;
          if (isPgSoft){ 
        	  jp= new GradientBasics.Panel(new BorderLayout()){
      		...
      		jp.putClientProperty("gradientStart", UIManager.getColor("Tooltip.gradientStart"));
    		jp.putClientProperty("gradientEnd", UIManager.getColor("Tooltip.gradientEnd"));
          ...
          if (northCentralComponent == null || cancel != null){
        	  if (toolTipText == null || !toolTipText.startsWith("<html>")){
            	  ...
            	  tip.setBorder(PersonalizableTable.BORDER_EMPTY);              
              }
          } else {
        	  tip.setBorder(PersonalizableTable.BORDER_EMPTY);              
          }
          ...
          if (toolTipText!=null){
        	  jp.setBorder(PersonalizableTable.BORDER_MAJOR);
          }
          if (anyComponentYouWant != null) {
              if (westPanel != null){
                  westPanel.setBackground(tip.getBackground());
                  westPanel.setOpaque(!isPgSoft);
  ...
  public JButton setCancel(final JButton cancel){
  ...
  public static ToolTipOnDemand getSingleton(){      
    isPgSoft=SwingBasics.isPageSoftLookAndFeel();
	return singleton;
  }
  ...
  private class ShowOnEntry extends MouseAdapter {
		...
		public void mouseExited(final MouseEvent e) {
			if (!com.MeehanMetaSpace.Basics.isEmpty(c.getToolTipText())) {
				hideTipWindow();				
			}
		}
