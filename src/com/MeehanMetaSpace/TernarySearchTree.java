...
public class TernarySearchTree {
	...
	*/
	public String matchPrefixString(String prefix, int numReturnValues) {
		...
		sortKeysBuffer = new StringBuilder();
		if(startNode.data != null) {
	...
	private StringBuilder sortKeysBuffer;		// convenience variable for matchPrefixString and sortKeys methods
	...
	*/
	...
	private StringBuilder matchAlmostBuffer;		// convenience variable for matchAlmostString
	...
	*/
	protected String matchAlmostString(String key, int numReturnValues) {
		...
		matchAlmostBuffer = new StringBuilder();
		matchAlmostKey = key;
		matchAlmostRecursion(rootNode, 0, matchAlmostDiff);
	...
	*/
	...
	private StringBuilder getKeyBuffer = new StringBuilder();   // convenience variable for getKey method
